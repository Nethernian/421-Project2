...
asmlinkage long sys_pqueue_init(void);
asmlinkage long sys_pqueue_shutdown(void);
asmlinkage long sys_pqueue_create(unsigned long priority);
asmlinkage long sys_pqueue_destroy(unsigned long priority);
asmlinkage long sys_pqueue_count(unsigned long piority);
asmlinkage long sys_pqueue_send(unsigned long priority, unsigned long PID);
asmlinkage long sys_pqueue_recv(unsigned long priority);
asmlinkage long sys_pqueue_delete(unsigned long priority);
